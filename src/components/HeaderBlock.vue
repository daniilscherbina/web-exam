<script setup>
  import HeaderTiles from './header_block/HeaderTiles.vue';
  import MobileMenu from './header_block/MobileMenu.vue';
  import MobileMenuList from './header_block/MobileMenuList.vue';
</script>
